                ...
                <table border="0" width="100%">
                    <tr>
                        <td style="text-align: justify;">
                            ...
                            generally
                            reported with a reference to the
                            <a href="http://java.sun.com/docs/books/jls/second_edition/html/jTOC.doc.html">Java Language
                                Specifications
                            </a>
                            (JLS x.x.x)
                            ...
                            <p/>
                            Rules checked also enforce adherence to
                            <a href="http://java.sun.com/docs/codeconv/html/CodeConvTOC.doc.html">Sun Java coding
                                guidelines
                            </a>
                            in use at Jakarta.
                            <p/>
                            ...
                            <i>possible</i>
                            errors. As always, use your best judgment and review
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="text-align:right">Designed for use with
                    <a href='http://www.webgain.com/products/quality_analyzer/'>Webgain QA/Metamata Audit</a>

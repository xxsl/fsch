...
InfoAfterFile=
OutputDir=/setup
OutputBaseFilename=fcsh-setup-1.0
...
Source: "msvbvm60.dll"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "oleaut32.dll"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "olepro32.dll"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "asycfilt.dll"; DestDir: "{sys}"; Flags: sharedfile
Source: "stdole2.tlb"; DestDir: "{sys}"; Flags: sharedfile regtypelib
Source: "COMCAT.DLL"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "ARINIMgr.dll"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "Redirect.dll"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "scrrun.dll"; DestDir: "{sys}"; Flags: uninsneveruninstall onlyifdoesntexist
Source: "COMCTL32.OCX"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "COMDLG32.OCX"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "RICHTX32.OCX"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "MSWINSCK.OCX"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "MSCOMCTL.OCX"; DestDir: "{sys}"; Flags: sharedfile regserver
Source: "COMCT232.OCX"; DestDir: "{sys}"; Flags: sharedfile regserver

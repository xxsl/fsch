...
'--------------------------------------------------------------------------------
' Project    :       Profiler
' Procedure  :       ANSItoUTF16
' Description:       ANSItoUTF16
' Created by :       Project Administrator
' Machine    :       BANANAS
' Date-Time  :       4.2.2011-17:13:53
'
' Parameters :       Text() (Byte)
'                    cPage (KnownCodePage = CP_UNKNOWN)
'                    lFlags (Long) As Byte()
'--------------------------------------------------------------------------------
'</CSCM>
Public Function ANSItoUTF16(ByRef Text() As Byte, _
                            Optional ByVal cPage As KnownCodePage = CP_UNKNOWN, _
...
'--------------------------------------------------------------------------------
' Project    :       Profiler
' Procedure  :       UTF16toANSI
' Description:       UTF16toANSI
' Created by :       Project Administrator
' Machine    :       BANANAS
' Date-Time  :       4.2.2011-17:13:53
'
...
'--------------------------------------------------------------------------------
'</CSCM>
Public Function UTF16toANSI(ByRef Text() As Byte, _
                            Optional ByVal cPage As KnownCodePage = CP_UNKNOWN, _
                            Optional lFlags As Long) As Byte()
...
'--------------------------------------------------------------------------------
' Project    :       Profiler
' Procedure  :       OemToCharS
' Description:       OemToCharS
' Created by :       Project Administrator
' Machine    :       BANANAS
' Date-Time  :       4.2.2011-17:13:53
'
' Parameters :       sOutput (String)
'--------------------------------------------------------------------------------
'</CSCM>
...
'--------------------------------------------------------------------------------
' Project    :       Profiler
' Procedure  :       ConvertStringToUtf8Bytes
' Description:       converts ansi string to UTF-8 byte array
' Created by :       Project Administrator
' Machine    :       BANANAS
' Date-Time  :       4.2.2011-17:13:53
'
' Parameters :       strText (String) As Byte()
'--------------------------------------------------------------------------------
'</CSCM>
...
'--------------------------------------------------------------------------------
' Project    :       Profiler
' Procedure  :       ConvertUtf8BytesToString
' Description:       converts UTF-8 byte array to ansi string
' Created by :       Project Administrator
' Machine    :       BANANAS
' Date-Time  :       4.2.2011-17:13:53
'

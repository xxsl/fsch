package components.files
{
        ...
        */
        [Event(name="CHANGE", type="components.files.FileMonitorEvent")]

        /**
        * Dispatched when the file being monitored is moved or deleted. The file
        * will be unwatched.
        */
        [Event(name="MOVE", type="components.files.FileMonitorEvent")]

        /**
        * Dispatched when the file being monitored is created.
        */
        [Event(name="CREATE", type="components.files.FileMonitorEvent")]
